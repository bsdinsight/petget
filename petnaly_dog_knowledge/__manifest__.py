...
""",
    ...
    'data': [
        ...
        'data/petnaly_dog_life_stage_data.xml',
        'data/petnaly_dog_color_data.xml',
        'data/petnaly_dog_breed_data.xml',
        'data/petnaly_breed_origin_data.xml',
        'data/petnaly_breed_growth_data.xml',
        'views/petnaly_dog_life_stage_views.xml',
        'views/petnaly_dog_color_views.xml',
