...
class PetgetFollowup(models.Model):
    _name = 'petget.followup'
    ...
    animal_id = fields.Many2one('petget.animal', string='Animal')
    reservation_id = fields.Many2one(
        'petget.reservation', string='Reservation', index=True, ondelete='cascade',
    )
