...
""",
    ...
    'data': [
        ...
        'security/petget_customer_followup_security.xml',
        'data/petget_followup_template_data.xml',
        'views/petget_followup_template_views.xml',
        'views/petget_followup_views.xml',
