...
class PetgetHeatCycle(models.Model):
    _name = 'petget.heat.cycle'
    ...
    animal_id = fields.Many2one(
        'petget.animal', string='Female', required=True, ondelete='cascade',
    ...
    progesterone_ids = fields.One2many(
        'petget.heat.progesterone', 'heat_cycle_id', string='Progesterone Tests',
    )
    ...
    mating_ids = fields.One2many('petget.mating', 'heat_cycle_id', string='Matings')
